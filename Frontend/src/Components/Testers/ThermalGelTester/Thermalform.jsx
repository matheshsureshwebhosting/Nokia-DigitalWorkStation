...
export class Thermalform extends Component {
    ...
    submitbtn = () => {
        ...
        if (Station.trim() === '') {
            ...
            this.setState({ isthermalform: true })
            // this.props.history.push("/Testers");
        }
    }

    render() {
        const { isthermalform } = this.state
        ...
        return (
            <>
                <Navbar logo="NOKIA" subTitle="Digital WorkStation" title="Thermal Gel PVA Robot AM Maintenance" />
...
const mapStateToProps = state => {
    return {
        pvaState: state.PvaStates
    }
}
const mapDispatchToProps = dispatch => {
    return {
        resetPvaState: () => dispatch(pvaActions.step_reset)
    }
}
export default connect(mapStateToProps, mapDispatchToProps)(Thermalform)
