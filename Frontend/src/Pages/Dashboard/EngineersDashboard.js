...
import ThermalTable from '../../Components/Tables/ThermalGelTable/ThermalTable';
import ThermalTables from '../../Components/Tables/ReportTable/ThermalTable';
                    ...
                    <Accordion defaultActiveKey="0">
                        ...
                        <Accordion.Collapse eventKey="1">
                            <ul className='dashboard-accordion-submenu'>
                                ...
                                <li onClick={() => setshowreportTable(4)}>Thermal Gel</li>
                            </ul>
                        </Accordion.Collapse>
                        ...
                        <Accordion.Collapse eventKey="0">
                            <ul className='dashboard-accordion-submenu'>
                                ...
                                <li onClick={() => setshowTable(4)}>Thermal Gel</li>
                            </ul>
                        </Accordion.Collapse>
                    </Accordion>
                </div>
